"""Tests for the visualization engine (Week 3-4 deliverable).

Covers all 7 chart types: histogram, scatter, box, heatmap, bar, line, pie.
Tests validate both the generated chart_config JSON and the base64 PNG image.
"""
...
@pytest.fixture
def health_df():
    """Patient demographics dataset matching the test fixture CSV."""
    return pd.DataFrame({
...
def _assert_valid_result(result: dict, chart_type: str):
    """Common assertions for all chart results."""
