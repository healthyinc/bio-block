...
from advanced_anonymizer import anonymize_dicom, anonymize_pdf

# HARDCODED PATHS AS REQUESTED
POPPLER_PATH = (
    r"C:\Users\Titas Ghosh\Downloads\Release-25.12.0-0\poppler-25.12.0\Library\bin"
)
...
def test_pdf_anonymization(test_pdf_path, tmp_path):
    ...
    anonymize_pdf(str(test_pdf_path), str(output_path), poppler_path=POPPLER_PATH)
