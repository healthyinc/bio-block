    ...
    try {
      ...
      try {
        ...
        if (shouldUseStreaming) {
          ...
          encryptedFile = await streamer.encryptFileStream(fileToUpload, (progress) => {
        ...
        if (previewFile) {
          try {
            ...
            if (shouldUseStreamingForPreview) {
              ...
              encryptedPreview = await previewStreamer.encryptFileStream(previewFile, (progress) =>
                console.log(`Preview encryption progress: ${progress.toFixed(1)}%`)
              );
            } else {
        ...
        const pythonBackendUrl =
          process.env.REACT_APP_PYTHON_BACKEND_URL || "http://localhost:3002";
        ...
        <div className="w-full max-w-2xl">
              ...
              <div className="mb-8">
                ...
                >
                  ...
                  <div className="pointer-events-none">
                    ...
                    <p
                      className={`${isWalletConnected ? "text-gray-500" : "text-gray-400"} text-sm`}
                    >
              ...
              <div className="mb-4">
                ...
                {previewType === "image" && previewUrl && !isGeneratingPreview && (
                  <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-gray-700">
                    <h4 className="text-lg font-semibold text-gray-200 mb-2">Preview:</h4>
                    <img
                      src={previewUrl}
                      alt="Preview"
                ...
                {previewType === "pdf" && previewUrl && !isGeneratingPreview && (
                  <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-gray-700">
                    <h4 className="text-lg font-semibold text-gray-200 mb-2">Preview:</h4>
                    <div
                      className="w-full border-2 border-gray-600 rounded-lg overflow-hidden"
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                ...
                <div className="md:col-span-2">
                    ...
                    >
                      ...
                      {diseaseOptions.map((disease) => (
                        <option
                          key={disease}
                          value={disease}
                          disabled={diseaseTags.includes(disease)}
                        >
                          {disease}
                        </option>
                      ))}
                        ...
                        {diseaseTags.map((tag, index) => (
                          ...
                          >
                            ...
                            <button
                              type="button"
                              onClick={() =>
                                setDiseaseTags(diseaseTags.filter((_, i) => i !== index))
                              }
                  ...
                  <p className="text-xs text-gray-500 mt-2">
                    Select multiple disease tags that apply to your document. Click on a tag to
                    remove it.
                  </p>
                </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-500">
              Your document will be encrypted and stored securely on IPFS with blockchain
              verification
            </p>
          </div>
        </div>
            ...
            {uploadProgress.isComplete && (
              <div className="space-y-3 mb-6 p-4 bg-green-50 rounded-2xl border border-green-200">
                <div className="text-sm">
                  ...
                  <p className="text-green-600 break-all font-mono text-xs mt-1">
